//package com.ashomok.cropimagelib;
//
...
// */
//@Deprecated
//public class CropImageActivityDeprecated extends AppCompatActivity
...
//    private static final String TAG = LogUtil.DEV_TAG + CropImageActivityDeprecated.class.getSimpleName();
...
//        sourceLanguageCodes = getIntent().getStringArrayListExtra(OcrActivity.EXTRA_LANGUAGES);
//
...
//                finish();
//            } else {
//                InfoSnackbarUtil.showError(R.string.unknown_error, mRootView);
//            }
//        } else {
//            String errorMessage = result.getError().getMessage();
//            if (errorMessage != null && errorMessage.length() > 0) {
//                InfoSnackbarUtil.showError(errorMessage, mRootView);
//            } else {
//                InfoSnackbarUtil.showError(R.string.unknown_error, mRootView);
//            }
//        }
